 ...
 * Output per stream:
 *   {
 *     name:    "🏴‍☠️ TPB 4K"   |  "🎬 Dahmer 4K"
 *     title:   "📺 4K | Remux\n🎥 HEVC | HDR10+ | DV\n🔊 TrueHD Atmos 7.1\n💾 45.2 GB\n..."
 *     url:     "https://p.111477.xyz/bulk?u=..." (Daher)
 *     headers: { "User-Agent": "Mozilla/5.0 (Android) ExoPlayer", "Referer": "https://a.111477.xyz/", "Range": "bytes=0-" }
 *     infoHash:"abc..."                          (TPB)
 *     sources: ["tracker:udp://..."]             (TPB)
 *   }
 */
...
function formatStream(s) {
  ...
  if (s.provider === 'daher') {
    stream.url = s.url;
    // Exactly matching Nuvio / ExoPlayer stream headers from dahmermovies-4k.js
    const reqHeaders = {
