...
function sortStreams(streams) {
  ...
  // Strict 4K-only filtering: if 4K streams exist, return ONLY 4K streams!
  ...
  console.log(`[filter] No 4K streams found (${sorted.length}), falling back to 1080p/HD streams`);
  return sorted;
}
